...
μCongruent = Sample mean of Congruent performance (in seconds)

μIncongruent = Sample mean of Incongruent performance (in seconds)

#### Hypotheses

This is a dependent test, where the same sample is tested pre and post treatment.

The Null Hypothesis would be that there is no difference in sample mean performance time for the Congruent and Incongruent samples.

The Alternative Hypothesis would be that there is a significant difference in sample mean performance time for the Congruent and Incongruent samples.
